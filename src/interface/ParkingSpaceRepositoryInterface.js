class ParkingSpaceRepositoryInterface {
  constructor() {
    if (new.target === ParkingSpaceRepositoryInterface) {
      throw new Error(
        "Não foi possível instanciar ParkingSpaceRepositoryInterface."
      );
    }
  }
  async add() {
...
module.exports = ParkingSpaceRepositoryInterface;
