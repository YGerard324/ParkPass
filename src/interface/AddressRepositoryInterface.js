class AdressRepositoryInterface {
  constructor() {
    if (new.target === AdressRepositoryInterface) {
      throw new Error(
        "Não foi possível instanciar AdressRepositoryInterface."
      );
    }
  }
  async add() {
...
module.exports = AdressRepositoryInterface;
