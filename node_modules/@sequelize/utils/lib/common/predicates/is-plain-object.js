...
}, (0, import_build_predicate_function.toBe)("a plain object (an object built using the literal syntax, or pojo())"));
const isPlainObject = tuple[0];
const isNotPlainObject = tuple[1];
