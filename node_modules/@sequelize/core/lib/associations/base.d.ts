...
export declare abstract class Association<S extends Model = Model, T extends Model = Model, ForeignKey extends string = string, Opts extends NormalizedAssociationOptions<ForeignKey> = NormalizedAssociationOptions<ForeignKey>> {
    ...
    abstract accessors: Record<string, string>;
...
export declare abstract class MultiAssociation<S extends Model = Model, T extends Model = Model, ForeignKey extends string = string, TargetKey extends AttributeNames<T> = any, Opts extends NormalizedAssociationOptions<ForeignKey> = NormalizedAssociationOptions<ForeignKey>> extends Association<S, T, ForeignKey, Opts> {
    static get isMultiAssociation(): boolean;
    protected toInstanceOrPkArray(input: AllowIterable<T | Exclude<T[TargetKey], any[]>> | Nullish): Array<T | Exclude<T[TargetKey], any[]>>;
    /**
     * Normalize input
     *
