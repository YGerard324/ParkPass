 ...
 * @private
 */
export declare class BaseSqlExpression {
}
export type DynamicSqlExpression = List | Value | Identifier | Attribute | Fn | DialectAwareFn | Col | Cast | Literal | Where | JsonPath | AssociationPath;
